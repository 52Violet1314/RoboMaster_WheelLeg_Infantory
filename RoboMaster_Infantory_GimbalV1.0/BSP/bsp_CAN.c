...
// /**
// ************************************************************************
// * @brief:      	fdcanx_send_data(FDCAN_HandleTypeDef *hfdcan, uint16_t
...
//   else
//     pTxHeader.DataLength = FDCAN_DLC_BYTES_8; // 默认值
...
// uint16_t rec_id2;
// void fdcan2_rx_callback(void) { fdcanx_receive(&hfdcan2, &rec_id2, rx_data2);
// } uint8_t rx_data3[8] = {0}; uint16_t rec_id3; void fdcan3_rx_callback(void)
// {
//   fdcanx_receive(&hfdcan3, &rec_id3, rx_data3);
//   if (rec_id3 == 0x011)
//   {
//     IMU_UpdateData(rx_data3);
//     // uart_print("IMUGetingData\r\n");
//     xEventGroupSetBitsFromISR(IMUEventGroup, IMU_DATA_READY_BIT, NULL);
//   }
// }
