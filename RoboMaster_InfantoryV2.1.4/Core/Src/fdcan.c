...
void MX_FDCAN1_Init(void)
{
  ...
  hfdcan1.Init.AutoRetransmission = DISABLE;  // 关重传：1kHz 控制循环丢 1 帧无影响，重传反会堵死 FIFO
  ...
  hfdcan1.Init.RxFifo0ElmtsNbr = 64;  // 增大缓冲防溢出
  ...
  hfdcan1.Init.TxFifoQueueElmtsNbr = 20;  // 翻倍安全余量
