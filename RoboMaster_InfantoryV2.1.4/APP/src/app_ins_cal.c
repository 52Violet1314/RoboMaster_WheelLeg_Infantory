...
void INS_Task(void)
{
    ...
    if ((count % 1) == 0)
    {
        ...
        // uart_print("Accel: %d.%3d, %d.%3d, %d.%3d\r\n", (int)(BMI088.Accel[X] *1000 )/1000, (int)(BMI088.Accel[X] * 1000)%1000, (int)(BMI088.Accel[Y] *1000) /1000, (int)(BMI088.Accel[Y] * 1000)%1000, (int)(BMI088.Accel[Z]*1000)/1000, (int)(BMI088.Accel[Z] * 1000)%1000);
